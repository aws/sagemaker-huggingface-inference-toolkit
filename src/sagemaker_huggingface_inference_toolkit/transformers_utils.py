...
SHARDED_INDEX_EXTENSION = ".index.json"
FRAMEWORK_MAPPING = {
    "pytorch": [PYTORCH_WEIGHTS_NAME, PYTORCH_WEIGHTS_NAME + SHARDED_INDEX_EXTENSION],
    "tensorflow": [TF2_WEIGHTS_NAME, TF2_WEIGHTS_NAME + SHARDED_INDEX_EXTENSION],
}
